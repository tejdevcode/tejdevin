...
import pic from "../../public/tej_pic.jpg";
...
const Header = () => {
   ...
   return (
      <>
         <div className="bg-white dark:bg-black backdrop-blur-lg backdrop-saturate-150 bg-opacity-50 dark:bg-opacity-50 h-16 shadow-md fixed top-0 left-0 right-0 z-50">
            <div className="max-w-screen-2xl container mx-auto sm:px-4 md:px-16 lg:px-20   ">
